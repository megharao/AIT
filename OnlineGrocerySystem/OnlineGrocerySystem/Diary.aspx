<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Diary.aspx.cs" Inherits="OnlineGrocerySystem.WebForm8" %>
...
ImageUrl='<%# Eval("Image") %>' Height="100" Width="200"/><br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select * from Product where Category='10'" ConnectionString="Data Source=(localdb)\ProjectsV13;Initial Catalog=master;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"></asp:SqlDataSource>
    <br />
        <br />
        <br />
        <br />    
