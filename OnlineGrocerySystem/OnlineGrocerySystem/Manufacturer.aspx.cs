...
namespace OnlineGrocerySystem
{
    public partial class Manufacturer : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            sql.CommandText = "insert into Manufacturer (Id, Name, ContactNumber, Address, Product, Category) values('" + ++id + "','" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "') ";
            sql.ExecuteNonQuery();
            con.Close();
