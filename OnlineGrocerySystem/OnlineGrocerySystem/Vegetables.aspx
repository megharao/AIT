<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Vegetables.aspx.cs" Inherits="OnlineGrocerySystem.WebForm6" %>
...
ImageUrl='<%# Eval("Image") %>' Height="100" Width="200"/><br />
                ...
                <asp:Button ID="Button1" runat="server" ForeColor="White" Font-Bold="true"  BackColor="#3399FF" Height="45px" Width="100px" Text="Add to Cart" OnClick="Button1_Click" />
             </ItemTemplate>
        </asp:DataList>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select * from Product where Category='2'" ConnectionString="Data Source=(localdb)\ProjectsV13;Initial Catalog=master;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"></asp:SqlDataSource>
    <br />
        <br />
        <br />
        <br />    
